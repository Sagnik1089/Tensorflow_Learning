...
prediction=model.predict(new_data_scaled)[0][0:2]
print(prediction)
#%%

calculated_first=(coeff[0]*values[0])-(coeff[1]*values[1])+(coeff[2]*values[2])-(coeff[3]*values[3])  
calculated_second=(coeff[3]*values[0])-(coeff[2]*values[1])+(coeff[1]*values[2])-(coeff[0]*values[3])
print("Calculated First: {}\t Predicted First: {}\nCalculated Second: {}\t Predicted Second: {}".format(calculated_first, prediction[0], calculated_second, prediction[1]))
#%%
# saving the model
